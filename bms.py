...
from_address = "senderaddress@gmail.com" # Sender address (Gmail address)
from_password = "senderpassword" # Sender server password (Gmail password)
to_address   = "recipientaddress@example.com" # Recipient address
